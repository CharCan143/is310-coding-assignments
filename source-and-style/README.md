...
- **CSS** used for the styling text on the page.
    
    ![Screenshot of CSS](images/CSS.png)
- **JavaScript** used and required for the page. Things like interactable elements such as buttons, search tools, media viewing, and other features of the like are done using JavaScript.
    
    ![Screenshot of JavaScript](images/JS.png)

File I didnt recognize:
- **ICO** which upon further inspection is an image file for an icon.
    
    ![Screenshot of ICO](images/ICO.png)
...
![Screenshot of Owners and Developers](images/credits.png)
